    ...
    class Program
    {
        ...
        private static void AddGame()
        {
            ...
            {   
                ...
                games[gameIndex].GameName = Console.ReadLine();

                Console.Write("Add game platform: ");
                games[gameIndex].Platform = Console.ReadLine();

                Console.Write("Add year of release: ");
                games[gameIndex].Year = Console.ReadLine();

                Console.Write("Add short game summary: ");
                games[gameIndex].GameSummary = Console.ReadLine();
